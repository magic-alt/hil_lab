...
#define HIL_PRU_B1_RAW_FIRMWARE_VERSION (0x00020100u)
#define HIL_PRU_B2_FIRMWARE_VERSION (0x00030000u)
...
#define HIL_PRU_B2_CAPABILITIES     (HIL_PRU_CAP_TIMEBASE | HIL_PRU_CAP_RPMSG |      HIL_PRU_CAP_FORCE_SAFE | HIL_PRU_CAP_STIMULUS_ENGINE |      HIL_PRU_CAP_ABZ_EMULATOR | HIL_PRU_CAP_SCHEDULED_GPIO)
