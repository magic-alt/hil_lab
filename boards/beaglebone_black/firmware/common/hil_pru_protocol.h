...
#define HIL_PRU_B1_RAW_FIRMWARE_VERSION (0x00020200u)
#define HIL_PRU_B2_FIRMWARE_VERSION (0x00031000u)
#define HIL_PRU_B2_SERIAL_FIRMWARE_VERSION (0x00032000u)
...
#define HIL_PRU_CAP_RAW_EDGE_CAPTURE           (1u << 8)
#define HIL_PRU_CAP_STIMULUS_ENGINE            (1u << 9)
#define HIL_PRU_CAP_ABZ_EMULATOR               (1u << 10)
#define HIL_PRU_CAP_SCHEDULED_GPIO             (1u << 11)
#define HIL_PRU_CAP_HALL_EMULATOR               (1u << 12)
#define HIL_PRU_CAP_SSI_EMULATOR                (1u << 13)
#define HIL_PRU_CAP_BISS_EMULATOR               (1u << 14)
#define HIL_PRU_CAP_SPI_SENSOR_EMULATOR         (1u << 15)
#define HIL_PRU_CAP_SCHEDULED_APPLY             (1u << 16)
...
#define HIL_PRU_B1_RAW_CAPABILITIES (HIL_PRU_CAP_TIMEBASE | HIL_PRU_CAP_RPMSG |      HIL_PRU_CAP_FORCE_SAFE | HIL_PRU_CAP_RAW_EDGE_CAPTURE |      HIL_PRU_CAP_SHARED_SNAPSHOT)

#define HIL_PRU_B2_CAPABILITIES     (HIL_PRU_CAP_TIMEBASE | HIL_PRU_CAP_RPMSG | \
     HIL_PRU_CAP_FORCE_SAFE | HIL_PRU_CAP_STIMULUS_ENGINE | \
     HIL_PRU_CAP_ABZ_EMULATOR | HIL_PRU_CAP_HALL_EMULATOR | \
     HIL_PRU_CAP_SCHEDULED_GPIO | HIL_PRU_CAP_SCHEDULED_APPLY)

#define HIL_PRU_B2_SERIAL_CAPABILITIES (HIL_PRU_CAP_TIMEBASE | HIL_PRU_CAP_RPMSG | \
     HIL_PRU_CAP_FORCE_SAFE | HIL_PRU_CAP_STIMULUS_ENGINE | \
     HIL_PRU_CAP_SSI_EMULATOR | HIL_PRU_CAP_BISS_EMULATOR | \
     HIL_PRU_CAP_SPI_SENSOR_EMULATOR)
...
#define HIL_PRU_MSG_RAW_CONFIG     (11u)
#define HIL_PRU_MSG_RAW_START      (12u)
#define HIL_PRU_MSG_RAW_STOP       (13u)
#define HIL_PRU_MSG_RAW_CLEAR      (14u)
#define HIL_PRU_MSG_RAW_STATUS     (15u)
#define HIL_PRU_MSG_ABZ_CONFIG     (16u)
#define HIL_PRU_MSG_ABZ_START      (17u)
#define HIL_PRU_MSG_ABZ_STOP       (18u)
#define HIL_PRU_MSG_ABZ_STATUS     (19u)
#define HIL_PRU_MSG_ABZ_DIRECTION  (20u)
#define HIL_PRU_MSG_ABZ_ARM        (21u)
#define HIL_PRU_MSG_ABZ_SCHEDULE   (22u)
#define HIL_PRU_MSG_HALL_CONFIG    (23u)
#define HIL_PRU_MSG_HALL_START     (24u)
#define HIL_PRU_MSG_HALL_STOP      (25u)
#define HIL_PRU_MSG_HALL_STATUS    (26u)
#define HIL_PRU_MSG_SERIAL_CONFIG  (27u)
#define HIL_PRU_MSG_SERIAL_DATA    (28u)
...
#define HIL_PRU_ERR_SCHEDULE_BUSY      (1u << 8)
#define HIL_PRU_ERR_UNSUPPORTED_MODE   (1u << 9)
#define HIL_PRU_ERR_NOT_ARMED          (1u << 10)
