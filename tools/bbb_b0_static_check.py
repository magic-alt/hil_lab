...
def main() -> int:
    ...
    require(resource_h, r"#include <pru_types\.h>", "PRU custom resource types header", errors)
    ...
    require(resource_c, r"TYPE_POSTLOAD_VENDOR,\s*\(PRU_INTS_VER0 \| TYPE_PRU_INTS\)", "PRU INTC postload resource type", errors)
    forbid(resource_c, r"TYPE_CUSTOM,\s*TYPE_PRU_INTS", "legacy PRU INTC resource type", errors)
